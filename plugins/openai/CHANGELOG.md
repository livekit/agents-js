...
- fix(plugin-openai): preserve realtime base URL query params. - [#1657](https://github.com/livekit/agents-js/pull/1657) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
