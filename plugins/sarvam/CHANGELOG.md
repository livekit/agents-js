...
- Send all audio frames to Sarvam instead of filtering quiet frames locally, preserving silence for server-side endpointing. Provider usage can increase because quiet audio is now sent. - [#2586](https://github.com/livekit/agents-js/pull/2586) ([@chenghao-mou](https://github.com/chenghao-mou))
