## API Report File for "@livekit/agents-plugin-runway"
...
// Warning: (ae-missing-release-tag) "RunwayException" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
