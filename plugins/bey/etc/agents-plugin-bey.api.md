## API Report File for "@livekit/agents-plugin-bey"
...
// Warning: (ae-missing-release-tag) "BeyException" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public
