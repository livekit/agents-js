...
- Validate live AssemblyAI options before mutating configuration, normalize regional language codes, and count and truncate agent context by Unicode code points. Model changes via updateOptions now fail explicitly; create a new STT instance to select a different model. - [#2476](https://github.com/livekit/agents-js/pull/2476) ([@meeranmalik](https://github.com/meeranmalik))
...
- Add support for AssemblyAI's Universal-3.6 Pro streaming model. - [#2409](https://github.com/livekit/agents-js/pull/2409) ([@rosetta-livekit-bot](https://github.com/apps/rosetta-livekit-bot))
