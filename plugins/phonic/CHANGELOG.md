...
- Add `allow_tool_chaining` to the Phonic plugin's per-tool `configsForTools`. Defaults to `false`; set it per tool to allow another tool call immediately after that tool's output. - [#2466](https://github.com/livekit/agents-js/pull/2466) ([@arunwpm-work](https://github.com/arunwpm-work))

- Add `enableWatermarking` realtime config option to gate Phonic's inaudible provenance watermark on generated audio. - [#2424](https://github.com/livekit/agents-js/pull/2424) ([@arunwpm-work](https://github.com/arunwpm-work))
