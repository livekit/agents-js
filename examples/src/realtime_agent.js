...
export default defineAgent({
    ...
    entry: async (ctx) => {
        ...
        const agent = new voice.Agent({
            instructions: "You are a helpful assistant created by LiveKit, always speaking English, you can hear the user's message and respond to it.",
            tools: {
                getWeather,
                toggleLight,
            },
...
//# sourceMappingURL=realtime_agent.js.map