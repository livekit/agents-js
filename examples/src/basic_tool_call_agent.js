...
class GameAgent extends voice.Agent {
    async onEnter() {
...
export default defineAgent({
    ...
    entry: async (ctx) => {
        ...
        const getNumber = llm.tool({
            description: 'Called when the user wants to get a number value, None if user want a random value',
            parameters: z.object({
...
//# sourceMappingURL=basic_tool_call_agent.js.map