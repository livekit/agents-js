...
function createUserData(agents) {
    return {
        customer: {},
        creditCard: {},
        agents,
...
function summarize({ customer, reservationTime, order, creditCard, expense, checkedOut, }) {
...
const updateName = llm.tool({
    description: 'Called when the user provides their name. Confirm the spelling with the user before calling the function.',
    parameters: z.object({
...
const updatePhone = llm.tool({
    description: 'Called when the user provides their phone number. Confirm the spelling with the user before calling the function.',
    parameters: z.object({
...
const toGreeter = llm.tool({
    description: 'Called when user asks any unrelated questions or requests any other services not in your job description.',
    execute: async (_, { ctx }) => {
...
function createGreeterAgent(menu) {
...
function createTakeawayAgent(menu) {
...
function createCheckoutAgent(menu) {
...
//# sourceMappingURL=restaurant_agent.js.map