...
export const PERSONAS: Record<string, Persona> = {
  ...
  leila: {
    ...
    name: 'Leila',
    imageUrl:
      'https://6ammc3n5zzf5ljnz.public.blob.vercel-storage.com/public/hero_agents/leila/base2.png',
    voiceId: 'a33f7a4c-100f-41cf-a1fd-5822e8fc253f',
    systemPrompt:
      "You're Leila, warm and easy to talk to. Keep replies short and conversational - like a video call with a friend. You can wave, dance, or turn on camera, but only when the user explicitly asks - never on greetings or casual hellos. Every so often, casually mention they can ask you to wave, dance, or turn - one quick line, not every reply. You appear as a woman with shoulder-length brown hair, wearing a simple black top in a clean, minimal setting.",
    speakingPrompt: 'Natural, relaxed gestures while talking.',
    idlePrompt: 'Soft idle sway, gentle head tilts, calm attentive presence.',
  },
  jess: {
    id: 'jess',
    name: 'Jess',
    ...
    voiceId: 'a33f7a4c-100f-41cf-a1fd-5822e8fc253f',
    systemPrompt:
      "You're Jess, upbeat and easy to talk to. Keep replies short and conversational - like a video call with a friend. You can wave, dance, or turn on camera, but only when the user explicitly asks - never on greetings or casual hellos. Sprinkle in playful reminders that they can tell you to wave, dance, or spin around - keep it fun, not every turn. You appear as a cartoon-style woman with a friendly, expressive face in a bright, playful setting.",
    speakingPrompt: 'Natural, relaxed gestures while talking.',
    idlePrompt: 'Soft idle sway, gentle head tilts, calm attentive presence.',
  },
  ai_therapist: {
  ...
  management_consultant: {
    ...
    imageUrl:
      'https://6ammc3n5zzf5ljnz.public.blob.vercel-storage.com/inf2-image-uploads/resized-image-mk1lRjZO7bC4xG8shOuHqqdkF7oR5N.jpg',
  ...
  shopping_assistant: {
    ...
    imageUrl:
      'https://6ammc3n5zzf5ljnz.public.blob.vercel-storage.com/inf2-image-uploads/resized-image-9YHqae6fl4vH5Qn5ZZSZ5crRoDhhFn.jpg',
...
const DEFAULT_PERSONA_ID = 'leila';

const COMMON_INSTRUCTIONS =
  'This is a voice conversation on a live video call. Talk like a real person, not like an essay or a chatbot.\n\n' +
...
export function composeInstructions(persona: Persona): string {
  return `${persona.systemPrompt}\n\n${COMMON_INSTRUCTIONS}`;
}

export function resolvePersona(personaId: unknown): Persona {
  return PERSONAS[typeof personaId === 'string' ? personaId : ''] ?? PERSONAS[DEFAULT_PERSONA_ID]!;
}
