...
describe('Calendar Integration Tests', () => {
    describe('CalComCalendar with real API', () => {
        it.skipIf(!process.env.CAL_API_KEY)('should initialize with real API key', async () => {
        ...
        it.skipIf(!process.env.CAL_API_KEY)('should list available slots with real API key', async () => {
            const calendar = new CalComCalendar({
                apiKey: process.env.CAL_API_KEY,
                timezone: 'America/New_York',
            });
...
//# sourceMappingURL=calendar_integration.test.js.map