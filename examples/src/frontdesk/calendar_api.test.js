...
import { CalComCalendar, FakeCalendar, SlotUnavailableError, createAvailableSlot, getUniqueHash, } from './calendar_api.js';
describe('Calendar API', () => {
    ...
    describe('CalComCalendar (mocked)', () => {
        ...
        describe('initialize', () => {
            ...
            it('should create new event type when not exists', async () => {
                ...
                expect(consoleSpy).toHaveBeenCalledWith('[cal.com] using cal.com username: testuser');
                expect(consoleSpy).toHaveBeenCalledWith('[cal.com] successfully added livekit-front-desk event type');
            ...
            it('should handle API errors', async () => {
                ...
                await expect(calendar.initialize()).rejects.toThrow('Failed to get user info: 401 Unauthorized');
            });
        });
        describe('scheduleAppointment', () => {
            ...
            it('should schedule appointment successfully', async () => {
                ...
                expect(mockFetch).toHaveBeenCalledWith('https://api.cal.com/v2/bookings', expect.objectContaining({
                    method: 'POST',
            ...
            it('should throw SlotUnavailableError for booking conflicts', async () => {
                ...
                await expect(calendar.scheduleAppointment({
                    startTime: new Date('2025-01-20T10:00:00Z'),
                    attendeeEmail: 'test@example.com',
        ...
        describe('listAvailableSlots', () => {
            ...
            it('should list available slots successfully', async () => {
                ...
                expect(mockFetch).toHaveBeenCalledWith('https://api.cal.com/v2/slots/?eventTypeId=123&start=2025-01-20T00%3A00%3A00.000Z&end=2025-01-21T00%3A00%3A00.000Z', expect.objectContaining({
                    headers: expect.objectContaining({
                        Authorization: 'Bearer test-api-key',
            ...
            it('should handle API errors', async () => {
                ...
                const startTime = new Date('2025-01-20T00:00:00Z');
                const endTime = new Date('2025-01-21T00:00:00Z');
                await expect(calendar.listAvailableSlots({ startTime, endTime })).rejects.toThrow('Failed to get available slots: 404 Not Found');
            });
    ...
    describe('FakeCalendar end-to-end', () => {
        it('should work as a complete calendar system', async () => {
            ...
            expect(remainingSlots.find((slot) => slot.startTime.getTime() === firstSlot.startTime.getTime())).toBeUndefined();
        });
    });
});
//# sourceMappingURL=calendar_api.test.js.map