...
// src/voice/agent_session.ts:1772:5 - (ae-forgotten-export) The symbol "STTError" needs to be exported by the entry point index.d.ts
// src/voice/agent_session.ts:1772:5 - (ae-forgotten-export) The symbol "TTSError" needs to be exported by the entry point index.d.ts
// src/voice/agent_session.ts:1772:5 - (ae-forgotten-export) The symbol "LLMError" needs to be exported by the entry point index.d.ts
