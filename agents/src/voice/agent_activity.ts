...
export class AgentActivity implements RecognitionHooks {
  ...
  // Ref: python livekit-agents/livekit/agents/voice/agent_activity.py - 320-339 lines
  ...
  private interruptByAudioActivity(): void {
    ...
    // Ref: python livekit-agents/livekit/agents/voice/agent_activity.py - 1618-1626 lines
    if (
      this.audioRecognition &&
