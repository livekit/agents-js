...
describe('SpeechHandle.addDoneCallback', () => {
  it('runs the remaining callbacks when one throws, without an unhandled rejection', async () => {
  ...
  it('contains a throwing callback added after the handle is done', async () => {
