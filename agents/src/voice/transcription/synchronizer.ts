...
class SyncedTextOutput extends TextOutput {
  ...
  // TextOutput.flush() is fire-and-forget for callers; this override awaits the rotation barrier
  // internally, so it returns a promise the base contract does not expose.
